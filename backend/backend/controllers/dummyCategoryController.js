...
exports.updateCategory = async (req, res) => {
  try {
    ...
    if (req.body.enableFreeText !== undefined) {
      doc.enableFreeText = req.body.enableFreeText === "true" || req.body.enableFreeText === true;
    }
    if (req.body.packagesIncludes !== undefined) {
  doc.packagesIncludes = req.body.packagesIncludes;
}
    if (req.body.offerText !== undefined) doc.offerText = req.body.offerText;
...
// ⭐ Offers section update (subcategory + category)
